...
# LS solution was += but the question I felt was not exaclty clear
# it said how can we make it predictable for the next programer
# so I made the method mutate both callers
=begin
